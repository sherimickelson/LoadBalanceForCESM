...
class OptimizeModel(object):
    ...
    def set_data(self, data_dict):
        ...
        #Added this to allow a choice between the optimizers -SK July 2020
        self.optimizer = data_dict['optimizer_choice']
...
# had to change the way the constraints are named because of GLPK-SK July 2020
